...
NON_DRUG_KEYWORDS = {
    ...
    "2-amino-1-methyl",
    "2-amino-4-(s-butylsulfonimidoyl)",
    "2-imino-1-methyl",
    "2h-indol-2-one",
    "3-isobutyl",
    "3-methyladenine",
...
def is_non_drug(name: str) -> bool:
    ...
    # 화학기호 패턴
    if re.search(
        r"\b(cation|anion|ion|hydrate|sulfate|chloride|bromide|iodide|"
        r"oxide|hydroxide|nitrate|nitrite|phosphate|carbonate|silicate)\b",
        n,
    ):
...
KNOWN_POSITIVE = {
    ...
    "ELAFIBRANOR",  # NASH
    "IDEBENONE",
    "ELTROMBOPAG",  # eltrombopag DILI 보고
    "ELTROMBOPAG",
    "DOMPERIDONE",
    "FENOLDOPAM",
    ...
    "RANOLAZINE",  # 협심증
    "OLMESARTAN",
    "TELMISARTAN",  # ARB는 대부분 안전한데 olmesartan 은 enteropathy
    "ELTROMBOPAG",
    "ROMIDEPSIN",
    "GALANTAMINE",
    "BUTALBITAL",
    ...
    "ETOFIBRATE",
    "PLAFIBRIDE",
    "LIFIBROL",  # fibrate 계열 — hepatotox
    "CARBIMAZOLE",
    "METHIMAZOLE",
    "METHYLTHIOURACIL",
    "BENZYLTHIOURACIL",
    "PROPYLTHIOURACIL",
    "AMITHIOZONE",  # antithyroid — hepatotox
...
KNOWN_NEGATIVE = {
    ...
    "ESTRADIOL",
    "TESTOSTERONE",
    "PROGESTERONE",  # 단순 호르몬 안전
    "HYDROCORTISONE",
    "CORTISONE",
    "BUDESONIDE",
    "DEFLAZACORT",
    "EVEROLIMUS",
    "RAPAMYCIN",  # 일부 hepatotox 있지만 약함
    "ABATACEPT",
    "ETANERCEPT",
    "ADALIMUMAB",
    "PRAZOSIN",
    ...
    "GUANFACINE",
    "ATEVIRDINE",
    "DELAVIRDINE",  # 위에서 양성, 보수적 사용
    "EZETIMIBE",
    "FENOFIBRATE",
    "ATORVASTATIN",
    "ROSUVASTATIN",  # 일부 hepatotox
    "AMPHOTERICIN B",
    "CASPOFUNGIN",
    "EBSELEN",
    "CALAMINE",
    ...
    "APIXABAN",
    "VEMURAFENIB",
    "DABRAFENIB",  # 위에서 양성 (BRAF, hepatotox)
    "DENOSUMAB",
    "TERIPARATIDE ACETATE",
    "DIFLUNISAL",
    "MELOXICAM",
    "METFORMIN",
    "PIOGLITAZONE",  # PIO는 일부 hepatotox
    "REPAGLINIDE",
    "NATEGLINIDE",
    "PROBENECID",
    "VENLAFAXINE",
    "DULOXETINE",  # DUL은 hepatotox 보고
    "MIRTAZAPINE",
    "BUPROPION",
    "ABACAVIR",
    "TENOFOVIR",  # 일부 hepatotox
    "LACOSAMIDE",
    "PREGABALIN",
    "GABAPENTIN",
    "ZONISAMIDE",
    ...
    "AMOXICILLIN",
    "AMPICILLIN",
    "AUGMENTIN",  # AUG는 hepatotox
    "DICLOXACILLIN",
    "FLUCLOXACILLIN",
    "OXACILLIN",  # OXA는 hepatotox
    "PIPERACILLIN",
    "TAZOBACTAM",
    "MEROPENEM",
    "ERTAPENEM",
    ...
    "ARIPIPRAZOLE",
    "ZIPRASIDONE",
    "CLOZAPINE",  # CLZ는 일부 hepatotox
    "CHLORPROMAZINE",  # CPZ는 cholestatic
    "FLUPHENAZINE",
    "HALOPERIDOL",  # 위 양성
    "PIPERACETAZINE",
    "PROMAZINE",
    "CHLORPROTHIXENE",  # 위 양성
    "TIAPRIDE",
    "SULPIRIDE",
    "AMISULPRIDE",
    "MOLINDONE",
    ...
    # 항돌기
    "ENTACAPONE",
    "TOLCAPONE",  # TOL은 시장 철수 hepatotox
    "RASAGILINE",
    "SELEGILINE",
    "AMANTADINE",
    "RIMANTADINE",
    ...
    "PHYTONADIONE",
    "DECITABINE",
    "RIBAVIRIN",  # 일부 hepatotox 보고이지만 보수적 음성
    "ETHCHLORVYNOL",
    "DIETHYLSTILBESTROL",
    "ETIDRONIC ACID",
    "FOSAPREPITANT",
